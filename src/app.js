...
initModel()
db.authenticate().then((res)=>{console.log('db authenticated')}).catch((error)=>{console.log(error)})
db.sync({alter: true}).then((res)=>{console.log('db syncronized')}).catch((error)=>{console.log(error)})
