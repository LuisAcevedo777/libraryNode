...
static async getOne(id){
        ...
        try{
            ...
            const getbooks = await bookModel.findByPk(id,{include:{model: loanModel, attributes:['user_id']}})
       return getbooks
    }catch(error){throw error}
}
...
static async updateOne(id, bookToUpdate){
        ...
        try{
               ...
               const bookUpdated = await bookModel.update(bookToUpdate,{where:{bookId:id}})
